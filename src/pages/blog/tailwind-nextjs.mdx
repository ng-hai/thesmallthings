...
[Another project template](https://github.com/nhducit/battery-included-nextjs) for Tailwind with Next.js that I’m interested in is from **nhducit**. It already includes a full set example using TypeScript and many other features. Should take a look.
